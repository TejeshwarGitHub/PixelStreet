...
public class LoginActivity2 extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        Toast.makeText(LoginActivity2.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
    }
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Toast.makeText(LoginActivity2.this, acct.getDisplayName(), Toast.LENGTH_SHORT).show();
